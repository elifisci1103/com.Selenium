...
public class XpathText { public static void main(String[] args) {
    ...
    driver.findElement(By.xpath("//*[text() = 'Add Element']")).click(); //Locatorlarda yazı varsa bu şekildede locate alınabilir.
